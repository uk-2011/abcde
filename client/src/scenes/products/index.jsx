...
import {Box,Card,CardActions,CardContent,Button,Typography,Rating,Collapse,useTheme,useMediaQuery} from "@mui/material";
...
borderRadius:"0.55rem",}}>
    ...
    <CardContent><Typography sx={{fontSize:14}} color={theme.palette.secondary[700]} gutterBottom>
        ...
        <CardActions>
            ...
            <Button variant="primary" onClick={()=>setIsExpanded(!isExpanded)} size="small">
                See More
            </Button>
        </CardActions>
